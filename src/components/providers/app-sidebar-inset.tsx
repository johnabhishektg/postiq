...
import { PanelLeft, ArrowLeftFromLine, ArrowRightFromLine } from "lucide-react";
...
function AppSidebarInset({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SidebarInset className="w-full flex-1 overflow-x-hidden bg-gray-50 border border-gray-200">
