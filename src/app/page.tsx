...
export default function Home() {
  return (
    <div className="relative h-screen grid grid-cols-3 md:flex-row bg-gray-50 overflow-hidden">
      {/* <Navbar /> */}
      {/* sidebar for desktop */}
      <div className="hidden md:block w-54 lg:w-54 border-r border-gray-100 p-6 h-full text-brand-900 relative z-10">
        <Sidebar />
      </div>
      <LinkedInPreview />
